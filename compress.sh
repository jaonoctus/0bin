...
# Built and minified by vendor_noble.sh. It is modern JS that uglifyjs may not
# parse, so it is concatenated as is.
echo $'\n''/* @noble/ciphers and @noble/hashes */' >>$MAIN_JS_OUTPUT
cat $JSDIR'noble.js' >>$MAIN_JS_OUTPUT
